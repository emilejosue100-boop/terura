  ...
  const steps = [
    {
      ...
      descEn: "Turn your cooperative paper ledger into a simple, secure digital fund with Terura. Save weekly alongside trusted members of your community.",
      descRw: "Hindura ikaye y’itsinda ryawe mu buryo bw’ikoranabuhanga ryizewe na Terura. Zigama buri cyumweru ufatanije n’abo wizera mu muryango wawe."
    },
    {
