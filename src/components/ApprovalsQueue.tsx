    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="space-y-3">
        ...
        {pendingList.length === 0 ? (
          <div className="bg-white border border-border-subtle rounded-xl p-8 text-center text-text-secondary text-sm">
            {language === 'en' ? 'No pending requests. All caught up!' : 'Nta busabe bw’inguzanyo buhari kuri ubu.'}
          </div>
        ) : (
      ...
      <div className="bg-white border border-border-subtle rounded-xl p-6 shadow-subtle">
        ...
        {pastList.length === 0 ? (
          <div className="text-center py-6 text-text-secondary text-xs">
            {language === 'en' ? 'No recent loan decisions found.' : 'Nta bikorwa by’inguzanyo biheruka.'}
          </div>
        ) : (
